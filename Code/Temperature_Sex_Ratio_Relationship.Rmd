...
## Visualization
We first want to visually inspect the influence of temperature on sex ratio. Here, we created a scatter plot with a smooth lines showing the trend. We fitted a linear regression line in orange to the plot.
```{r scatter plot}
